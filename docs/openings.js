...
elements.size11Btn?.addEventListener("click", (event) => {
  handlePageButtonClick(event, "./openings.html", () => void loadBoardSize(11))
})
elements.size12Btn?.addEventListener("click", (event) => {
  handlePageButtonClick(event, "./openings.html#12", () => void loadBoardSize(12))
})
elements.size13Btn?.addEventListener("click", (event) => {
  handlePageButtonClick(event, "./openings.html#13", () => void loadBoardSize(13))
})
elements.size14Btn?.addEventListener("click", (event) => {
  handlePageButtonClick(event, "./openings.html#14", () => void loadBoardSize(14))
})
elements.size17Btn?.addEventListener("click", (event) => {
  handlePageButtonClick(event, "./openings.html#17", () => void loadBoardSize(17))
})
