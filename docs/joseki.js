...
function normalizeLoadedData(rawBuffer) {
  ...
  for (let idx = 0; idx < nodeCount; idx += 1) {
    ...
    rawNodes.push({
      ...
      moveCode: view.getUint8(offset + 3),
      localCount: flags & 0x1F,
      isCore: (flags & 0x20) !== 0,
      tenukiRetained: (flags & 0x40) !== 0,
      tenukiPresent: (flags & 0x80) !== 0,
      tenukiStoneFraction: view.getUint16(offset + 5, true),
    })
