...
elements.familyABtn.addEventListener("click", (event) => {
  handlePageButtonClick(event, "./joseki.html", () => handleFamilyButtonClick("A"))
})
elements.familyOBtn.addEventListener("click", (event) => {
  handlePageButtonClick(event, "./joseki.html#O", () => handleFamilyButtonClick("O"))
})
