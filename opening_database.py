...
def _fair_root_sweep_payload_from_child_analyze(
    *,
    root_position: str,
    ...
    for move in requested_moves:
        ...
        if not isinstance(red_wr, (int, float)):
            raise ValueError(f"fair-root analyze payload missing root winrate for move {move!r}")
...
def _run_fair_root_candidate_sweep_cached(
    *,
    ...
    reduced = _fair_root_sweep_payload_from_child_analyze(
