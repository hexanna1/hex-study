...
def _child_analyze_rows_payload(
    *,
    parent_position: str,
...
def _finalize_node_expansion(
    ...
    *,
    ...
    parent_position, _parent_to_play, tenuki_move, local_meta_by_cell, child_positions_by_move = prepared
    analyze_rows_payload = _child_analyze_rows_payload(
        parent_position=parent_position,
        child_positions_by_move=child_positions_by_move,
        analyze_payloads=analyze_payloads,
    )
    rows = lps._aggregate_moves(
        analyze_rows_payload,
