...
class PatternStudyBatchTests(unittest.TestCase):
    ...
    def test_run_one_reuses_existing_valid_tile_json(self):
        with TemporaryDirectory() as td:
            ...
            aj.dump_pattern_tile(output_json, self._valid_tile_spec())
            with mock.patch("pattern_study_batch._spawn_tracked_proc") as spawn_mock:
    ...
    def test_run_one_reruns_when_existing_tile_json_is_invalid(self):
        with TemporaryDirectory() as td:
            ...
            class FakeProc:
                ...
                def wait(self):
                    aj.dump_pattern_tile(output_json, valid_tile_spec())
    ...
    def test_terminate_active_procs_kills_live_process_groups(self):
        ...
        with (
            ...
            wait_live.side_effect = pattern_study_batch.subprocess.TimeoutExpired(
                cmd="pattern_study.py",
                timeout=2.0,
            )
