...
class PatternEnumerationTests(unittest.TestCase):
    def test_single_stone_is_connected(self):
        self.assertTrue(pattern_enumerate._is_connected(((0, 0),), Δ_max=4))

    def test_two_far_clusters_are_not_connected(self):
        pts = ((0, 0), (0, 1), (10, 0), (10, 1))
        self.assertFalse(pattern_enumerate._is_connected(pts, Δ_max=4))
    ...
    def test_enumerate_patterns_small_exact_catalog(self):
        catalog = pattern_enumerate.enumerate_patterns(max_moves=2, max_pair_delta=4, candidate_Δ_max=3)
        ...
        self.assertEqual(by_pattern["+[0,0]-[0,1]"]["candidate_Δ_max"], 3)
    ...
    def test_enumerate_patterns_odd_max_moves_adds_only_the_families_within_budget(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {"plus": 1, "minus": 2, "to_play": "blue", "count": 10},
            ],
        )
    ...
    def test_default_artifact_dir_uses_total_move_cap_label(self):
        ...
        self.assertEqual(path, Path("artifacts") / "interior_patterns_m5_d4_span12")
