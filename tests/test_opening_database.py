...
class OpeningDatabaseTests(unittest.TestCase):
    ...
    def test_fair_root_sweep_uses_child_position_analyze_cache(self):
        ...
        with (
            ...
            mock.patch.object(
                od,
                "_run_multi_position_analyze_cached",
                return_value=child_payloads,
            ) as analyze_mock,
        ):
        ...
        self.assertEqual(
            analyze_mock.call_args.kwargs["position_inputs"],
    ...
    def test_finalize_node_uses_only_anchor_candidates_for_best_elo_baseline(self):
        ...
        self.assertAlmostEqual(by_move["b4"]["stone_fraction"], 1.0, places=6)
    ...
    def test_prune_raw_nn_cache_keeps_retained_and_nonretained_child_rows(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            od.lps._save_raw_nn_cache(cache_path, cache)
