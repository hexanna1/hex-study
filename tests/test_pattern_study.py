...
class PatternStudyTests(unittest.TestCase):
    ...
    def test_main_nondebug_writes_compact_local_map_json_only(self):
        ...
        child_payloads = {
            lps._position_after_move(rep.position, "k1"): {"r": 0.4, "m": [["a1", 0.1]]},
            lps._position_after_move(rep.position, "j11"): {"r": 0.6, "m": [["a1", 0.1]]},
            lps._position_after_move("https://hexworld.org/board/#21c1,a1d2", "k1"): {"r": 0.4, "m": [["a1", 0.1]]},
            lps._position_after_move("https://hexworld.org/board/#21c1,a1d2", "j11"): {"r": 0.6, "m": [["a1", 0.1]]},
        }
        ...
        with TemporaryDirectory() as td:
            ...
            with (
                ...
                mock.patch(
                    "pattern_study.lps._run_multi_position_raw_nn_native",
                    side_effect=[
                        {
