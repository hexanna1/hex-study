...
STUDY_TARGETS: tuple[StudyTarget, ...] = (
    StudyTarget(delta=12, hexworld="https://hexworld.org/board/#21c1,k11"),
    StudyTarget(delta=12, hexworld="https://hexworld.org/board/#21c1,k11:p"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,k10k11"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,k12l10"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,k12k11l10"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,j13j11l10"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,k11k10k12"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,k11k10l12"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,j12j13k10m10"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,j11j12k12l10"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,j12k13k10l11"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,j11k11j12l10"),
    StudyTarget(delta=3, hexworld="https://hexworld.org/board/#21c1,j11k10j12k11"),
)
...
def _parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--delta", type=int, default=None, help="Override study delta for all catalog-driven runs")
...
def _write_manifest(
    *,
    ...
    payload = {
        ...
        "targets": [{"delta": int(t.delta), "hexworld": str(t.hexworld)} for t in targets],
