...
Practical intuition for symmetric cases:
...
- place each orientation in the middle of the board,
...
Instead of starting from one supplied HexWorld position, this workflow can start from exhaustive pattern enumeration.

The sweep does the following:
