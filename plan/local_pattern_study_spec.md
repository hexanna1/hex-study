...
- keep only connected shapes under the chosen locality radius,
- optionally keep only shapes with bounded maximum pairwise span,
...
- component locality threshold `Δ7`,
- overall span bounded by `Δ12`.
